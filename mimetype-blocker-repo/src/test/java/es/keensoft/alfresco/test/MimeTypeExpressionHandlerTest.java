...
*/
	private static List<String> restrictingExpressions = Arrays.asList(new String[]{
			"video*",
			"*xml",
			"*pdf*",
			...
			"",
			"video*|*xml|*pdf*|application/octet-stream"
	});
	
	public static void main(String... args) throws Exception {
		
		MimeTypeExpressionHandler mteh = new MimeTypeExpressionHandler();
